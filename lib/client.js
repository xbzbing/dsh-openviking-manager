...
function ManagerForm({ apiPrefix = "/plugins/dsh-openviking-manager/api", fetchFn = fetch, t = createTranslation(browserLocale()) }) {
  ...
  const loadRecallScope = async () => {
    try {
      ...
      setRecallScope(void 0);
    }
  };
  (0, import_react.useEffect)(() => {
    void load();
    void loadVersion();
    void loadRecallScope();
  }, []);
  ...
  const setScope = async (allowSharing) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { className: "ovm-shell", children: [
    ...
    recallScope === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "ovm-card", "aria-label": t("isolationTitle"), children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "ovm-checkRow", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t("allowCrossTopicLabel") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ovm-hint", children: t("isolationHint") }),
      ...
      recallScope.restartPending ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ovm-restartRow", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ovm-hint", children: t("restartSideEffects") }),
...
.ovm-checkRow{display:flex;align-items:center;gap:8px;margin-top:4px;font-size:13px;font-weight:600;cursor:pointer}.ovm-checkRow input{height:auto;width:auto;margin:0;accent-color:#1f5d50;cursor:pointer}.ovm-checkRow input:disabled{cursor:default}.ovm-restartRow{display:grid;gap:8px;margin-top:12px}.ovm-restartRow .ovm-warning{margin:0}.ovm-restartRow button{justify-self:start;border:0;border-radius:7px;padding:8px 13px;font:inherit;font-size:13px;background:#1f4038;color:#fff;cursor:pointer}.ovm-restartRow button:disabled{opacity:.55}
`;
