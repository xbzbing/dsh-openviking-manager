...
function ManagerForm({ apiPrefix = "/plugins/dsh-openviking-manager/api", fetchFn = fetch, t = createTranslation(browserLocale()) }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { className: "ovm-shell", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "ovm-card ovm-about", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: t("aboutTitle") }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ovm-hint", children: t("currentVersion", { version: version?.current ?? "\u2026" }) }),
      version?.repositoryUrl !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "ovm-hint", children: [
        t("githubRepository"),
        ": ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: version.repositoryUrl, target: "_blank", rel: "noreferrer", children: version.repositoryUrl })
      ] }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ovm-actions", children: [
      ...
      versionStatus !== "" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: version?.error !== void 0 ? "ovm-warning" : "ovm-status", role: "status", children: versionStatus }) : null
    ] })
  ] });
}
