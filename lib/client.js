...
function AdminIdentityForm(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { className: "ovm-adminForm", onSubmit: (event) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "submit", className: props.danger ? "ovm-danger" : "", disabled: props.disabled, children: props.submit })
  ] });
}
function ManagerForm({ apiPrefix = "/plugins/dsh-openviking-manager/api", fetchFn = fetch, t = createTranslation(browserLocale()) }) {
  ...
  const [activeAdminTab, setActiveAdminTab] = (0, import_react.useState)("create-account");
  const load = async () => {
    setBusy(true);
    try {
  ...
  const adminCall = async (operation, fields = {}) => {
    ...
    try {
      ...
      setAdminStatus(error instanceof Error ? error.message : t("adminFailed"));
    } finally {
      setBusy(false);
    }
  };
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { className: "ovm-card", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { className: "ovm-recovery", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ovm-recoveryContent", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ovm-actions", children: [
          ...
          rootApiKey !== "" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "ovm-secondary", disabled: busy, onClick: () => {
            setRootApiKey("");
...
function apply(ctx) {
  ...
  ctx.slots.inject(
    ...
    () => ctx.slots.register(
      ...
      (props) => props.view === "summary" ? props.t("summary") : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ManagerForm, { t: props.t })
    )
  );
}
