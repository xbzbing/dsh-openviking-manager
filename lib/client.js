...
function AdminIdentityForm(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { className: "ovm-adminForm", onSubmit: (event) => {
    ...
    ] }) : accountsMissing ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ovm-hint", children: props.noAccountsLabel }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
      props.accountLabel,
