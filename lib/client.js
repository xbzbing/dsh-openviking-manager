...
function ManagerForm({ apiPrefix = "/plugins/dsh-openviking-manager/api", fetchFn = fetch, t = createTranslation(browserLocale()) }) {
  ...
  const [peerIdDraft, setPeerIdDraft] = (0, import_react.useState)("");
  const load = async () => {
    setBusy(true);
    try {
  ...
  const loadPeerId = async (hideOnFailure = true) => {
    try {
      const value = (await responseJson(await fetchFn(`${apiPrefix}/recall-peer`))).value;
      setPeerId(value);
      return value;
    } catch {
      if (hideOnFailure) setPeerId(void 0);
      return void 0;
    }
  };
  (0, import_react.useEffect)(() => {
  ...
  const initializeRecallSettings = async () => {
    ...
    try {
      ...
      setStatus(step === "scope" ? t("isolationSaveFailed") : t("tuningSaveFailed", { error: error instanceof Error ? error.message : "unknown" }));
    } finally {
      setBusy(false);
    }
  };
  ...
  const saveTuning = async (event) => {
    ...
    if (!tuning) return;
    const payload = {
      scoreThreshold: tuningDraft.scoreThreshold.trim() === "" ? tuning.scoreThreshold.pinned ? tuning.scoreThreshold.default : null : Number(tuningDraft.scoreThreshold),
  ...
  const peerIdLocked = peerId !== void 0 && (peerId.source === "env" || peerId.source === "ovcli");
  const savePeerIdValue = async (event) => {
    event.preventDefault();
    if (!peerId) return;
    setBusy(true);
    try {
  ...
  const fillCurrentRepo = async () => {
    setBusy(true);
    try {
      const value = (await responseJson(await fetchFn(`${apiPrefix}/recall-peer/derive`))).value;
      if (value.peerId === "") setStatus(t("peerIdNotInRepo"));
      else {
        setPeerIdDraft(value.peerId);
        setStatus(t("peerIdDetected", { peerId: value.peerId }));
      }
    } catch (error) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { className: "ovm-shell", children: [
    ...
    peerId === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "ovm-card", "aria-label": t("peerIdLabel"), children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { className: "ovm-peerId ovm-collapse", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("summary", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: t("peerIdLabel") }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ovm-collapseContent", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ovm-hint", children: t("peerIdHint") }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { onSubmit: (event) => void savePeerIdValue(event), children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
              t("peerIdLabel"),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "input",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ovm-actions", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "ovm-secondary", disabled: busy || peerIdLocked, onClick: () => void fillCurrentRepo(), children: t("fillCurrentRepo") }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "submit", disabled: busy || peerIdLocked, children: t("savePeerId") })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ovm-hint", children: peerIdDraft.trim() === "" ? t("peerIdHintEmpty") : t("peerIdHintSet") }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ovm-hint ovm-isolationHint", children: t("peerIdMultiRepoNotice") }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ovm-hint", children: t("peerIdReloadNotice") })
        ] })
      ] }),
      peerId.source === "env" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ovm-warning", role: "alert", children: t("peerIdEnvWarning") }) : null,
      peerId.source === "ovcli" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ovm-warning", role: "alert", children: t("peerIdCredentialWarning") }) : null
    ] }),
    recallTuning === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "ovm-card", "aria-label": t("tuningTitle"), children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { className: "ovm-tuning ovm-collapse", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("summary", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: t("tuningTitle") }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ovm-collapseContent", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { className: "ovm-card", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { className: "ovm-recovery ovm-collapse", children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ovm-ovToggleLabel", children: t("toggleLabel") })
      ]
    }
  );
}
...
var managerCss = `
.ovm-collapse>summary{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:4px 0;cursor:pointer;list-style:none}.ovm-collapse>summary::-webkit-details-marker{display:none}.ovm-collapse>summary>h2{margin:0}.ovm-collapse>summary::after{content:"+";flex:0 0 auto;display:grid;place-items:center;width:24px;height:24px;border:1px solid var(--dsw-alias-border-l2,#dce1e6);border-radius:7px;color:var(--dsw-alias-label-secondary,#59636e);font-size:15px;line-height:1;transition:background .15s ease}.ovm-collapse>summary:hover::after{background:var(--dsw-alias-bg-layer-1,#f6f8fa)}.ovm-collapse>summary:focus-visible{outline:2px solid #1f5d50;outline-offset:3px;border-radius:8px}.ovm-collapse[open]>summary::after{content:"\u2212"}.ovm-collapseContent{display:grid;gap:14px;margin-top:18px}.ovm-adminTabs{display:flex;gap:4px;overflow-x:auto;border-bottom:1px solid var(--dsw-alias-border-l2,#dce1e6)}.ovm-adminTab{flex:0 0 auto;border:0;border-bottom:2px solid transparent;background:transparent;color:var(--dsw-alias-label-secondary,#59636e);padding:8px 10px;font:inherit;font-size:13px}.ovm-adminTab:hover{background:var(--dsw-alias-bg-layer-1,#f6f8fa)}.ovm-adminTabActive{border-bottom-color:#1f5d50;color:#1f4038;font-weight:600}.ovm-adminTabs+div .ovm-adminForm{margin-top:14px}
...
.ovm-standaloneToggle{padding:12px 28px 0}.ovm-ovToggle{position:relative;display:inline-flex;align-items:center;gap:6px;border:1px solid var(--dsw-alias-border-l2,#ccd3da);border-radius:999px;background:var(--dsw-alias-bg-layer-1,#f6f8fa);color:var(--dsw-alias-label-secondary,#59636e);padding:2px 10px;font:inherit;font-size:13px;font-weight:500;line-height:20px;cursor:pointer;white-space:nowrap}.ovm-ovToggle:hover:not(:disabled){background:var(--dsw-alias-bg-layer-2,#fff);color:var(--dsw-alias-label-primary,#202124)}.ovm-ovToggle:focus-visible{outline:2px solid #1f5d50;outline-offset:2px}.ovm-ovToggle:disabled{opacity:.6;cursor:default}.ovm-ovToggleDot{width:7px;height:7px;border-radius:50%;background:#1f8a70;flex:0 0 auto}.ovm-ovToggleOff .ovm-ovToggleDot{background:#9aa5b1}.ovm-ovToggleOff,.ovm-ovToggleOff:hover:not(:disabled){color:var(--dsw-alias-label-tertiary,#77818b)}.ovm-ovToggle::after{content:attr(data-ovm-tip);position:absolute;left:0;bottom:calc(100% + 8px);z-index:60;width:max-content;max-width:260px;padding:5px 9px;border-radius:7px;background:#202124;color:#fff;font-size:12px;font-weight:400;line-height:1.45;white-space:normal;text-align:left;opacity:0;visibility:hidden;transition:opacity .12s ease;box-shadow:0 4px 14px rgba(32,33,36,.28);pointer-events:none}.ovm-ovToggle:hover::after,.ovm-ovToggle:focus-visible::after{opacity:1;visibility:visible}.ovm-standaloneToggle .ovm-ovToggle::after{top:calc(100% + 8px);bottom:auto}
@container (width<=560px){.ovm-ovToggle{box-sizing:border-box;justify-content:center;gap:0;width:28px;height:28px;padding:0}.ovm-ovToggleLabel{display:none}}
@media (max-width:560px){.ovm-ovToggle{box-sizing:border-box;justify-content:center;gap:0;width:28px;height:28px;padding:0}.ovm-ovToggleLabel{display:none}}
